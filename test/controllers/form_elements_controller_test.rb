...
class FormElementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create form_element" do
    assert_difference("FormElement.count") do
      post form_elements_url, params: {form_element: {custom_form_id: @form_element.custom_form_id, input_type: @form_element.input_type, label: @form_element.label, position: @form_element.position}}
    end
  ...
  test "should update form_element" do
    patch form_element_url(@form_element), params: {form_element: {custom_form_id: @form_element.custom_form_id, input_type: @form_element.input_type, label: @form_element.label, position: @form_element.position}}
